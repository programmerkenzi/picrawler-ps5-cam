...
def joystick_control():
    ...
    while True:
        ...
        if joystick.get_button(4):
            ...
            front_leg_angle = clamp(front_leg_angle - 1, NORMAL_HEIGHT, RAISED_MAX)
        robot.set_angle([[90, front_leg_angle, 90]], [0])
        robot.set_angle([[90, front_leg_angle, 90]], [1])  # LF, RF
        ...
        if joystick.get_button(5):
            ...
            back_leg_angle = clamp(back_leg_angle - 1, NORMAL_HEIGHT, RAISED_MAX)
        robot.set_angle([[90, back_leg_angle, 90]], [2])
        robot.set_angle([[90, back_leg_angle, 90]], [3])  # LB, RB
